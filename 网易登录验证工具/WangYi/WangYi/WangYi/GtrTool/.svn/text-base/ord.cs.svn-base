...
namespace GTR
{
    ...
    class Game
    {
        ...
        static extern bool PostMessage(IntPtr hwnd, int msg, uint wParam, IntPtr lParam); 
        ...
        public static void SendString(IntPtr hWnd, string str,bool AppEnd)
        {
            ...
            for (int i = 0; i < str.Length; i++)
            {
                ...
                //PostMessage(hWnd, 0x004A, sc, IntPtr.Zero); 
                SendMessage(hWnd, 0x004A, sc, IntPtr.Zero);
        ...
        //{
        //    string tmp = SetPicPath(ZH_QQ.picPathFolder, ZH_QQ.OrdNo);
        //    ImageTool.GetScreenCapture(rect).Save(tmp, ImageFormat.Jpeg);
        //}
        ////public static void CaptureJpg(RECT rect, bool BmpKey)
        ////{
        ////    string tmp = SetPicPath(ZH_QQ.m_strPictureDir, ZH_QQ.OrdNo);
        ////    ImageTool.GetScreenCapture(rect).Save(tmp, ImageFormat.Bmp);
        ////}
        //public static void CaptureJpg()
        //{
        //    //if (ZH_QQ.m_hGameWnd == IntPtr.Zero)
        //    string tmp=SetPicPath(ZH_QQ.m_strPictureDir,ZH_QQ.OrdNo);
        //    RECT rect= new RECT();
        //    User32API.GetClientRect(ZH_QQ.m_hGameWnd, out rect);
        //    ImageTool.GetScreenCapture(rect).Save(tmp, ImageFormat.Jpeg);
        ...
        public static string SetPicPath(string strPictureDir, string strOrderNo)
        {
            ...
            strFileName = string.Format("{0}{1:00}{2:00}{3:00}.jpg", strPictureDir, dt.Hour, dt.Minute, dt.Second);
            return strFileName;
        }
