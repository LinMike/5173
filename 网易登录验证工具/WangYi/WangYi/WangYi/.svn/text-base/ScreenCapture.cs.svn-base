...
namespace GamePic
{
    ...
    public class ScreenCapture
    {
        ...
        public static bool PrtWindowHWNDBMP(IntPtr hWnd, string strPictureDir, int picNo)
        {
            string strPicName = "";
            ...
            string strFileName = "";
            DateTime dt = DateTime.Now;
            strFileName = string.Format("{0}{1:00}{2:00}{3:00}{4}.bmp", strPictureDir, dt.Hour, dt.Minute, dt.Second, strPicName);

            RECT rect;
            GetWindowRect(hWnd, out rect);
            return PrtWindowBMP(hWnd, strFileName, rect);
        }
        public static bool PrtWindowBMP(IntPtr hWnd, string strFileName, RECT rect)
        {
